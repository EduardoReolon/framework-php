    ...
    public function htmlPagesNumbers(string $query_string = '', int $pages_visible = 15) {
        ...
        ?>
            <div aria-label="Page navigation example">
                <ul class="pagination">
                    <?php
                        echo "<li class=\"page-item\"><a class=\"page-link\" href=\"" . $this->linkPage(1, $query_string) . "\">Primeira</a></li>";
                        $pDisabled = $this->page > 1 ? '' : ' disabled';
                        echo "<li class=\"page-item{$pDisabled}\"><a{$pDisabled} class=\"page-link\" href=\"" . $this->linkPage($this->page - 1, $query_string) . "\">Anterior</a></li>";
                        ...
                        if ($start_page > 1) echo "<li class=\"page-item disabled\"><a disabled class=\"page-link\" href=\"\">...</a></li>";
                        for ($i=$start_page; $i <= $end_page ; $i++) { 
                            $selected = $i === $this->page ? ' active' : '';
                            echo "<li class=\"page-item{$selected}\"><a class=\"page-link\" href=\"{$this->linkPage($i, $query_string)}\">{$i}</a></li>";
                        }

                        if ($end_page < $this->total_pages) echo "<li class=\"page-item disabled\"><a disabled class=\"page-link\" href=\"\">...</a></li>";

                        $nDisabled = $this->page < $this->total_pages ? '' : ' disabled';
                        echo "<li class=\"page-item{$nDisabled}\"><a{$nDisabled} class=\"page-link\" href=\"" . $this->linkPage($this->page + 1, $query_string) . "\">Próximo</a></li>";
                        
                        echo "<li class=\"page-item\"><a class=\"page-link\" href=\"" . $this->linkPage($this->total_pages, $query_string) . "\">Última</a></li>";
                    ?>
                </ul>
            </div>
        <?php
